...
export default function AboutCravingSection() {
  return (
    <section className="py-56 px-4 bg-[#eef1ef]">
      <div className="container px-12 mx-auto flex flex-col md:flex-row items-center justify-center gap-12">
        {/* Left image */}
        <div className="flex-shrink-0 relative -top-32">
          <img
            src="/img/hero.jpg"
            alt="Hero image"
        ...
        <div className="flex-1 text-center ">
          <h2 className="font-forum text-4xl md:text-7xl font-semibold text-[#22223B] mb-6 leading-tight">
        ...
        {/* Right image */}
        <div className="flex-shrink-0 relative -bottom-32">
          <img
            src="/img/hero.jpg"
            alt="Chef smiling"
            className="w-[236px] h-[366px]  object-cover rounded-full shadow-lg"
